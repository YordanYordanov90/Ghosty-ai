...
- Project metadata and relationships belong in PostgreSQL via Drizzle ORM.
- Canvas snapshots and generated specs belong in Vercel Blob; the database stores only the blob URL reference.
...
- `lib/` — shared infrastructure: Drizzle ORM client, auth helpers, utilities.
